...
public class RomVersionDetailPreferenceController extends BasePreferenceController {
    ...
    private static final Uri INTENT_URI_DATA = Uri.parse("https://paypal.me/atlantisos");
    private static final String TAG = "romDialogCtrl";
    private static final String KEY_ROM_VERSION_PROP = "ro.atlantis.build.version";
    private static final String KEY_ROM_RELEASETYPE_PROP = "ro.atlantis.build.type";
    private static final String KEY_ROM_VARIANT_PROP = "ro.atlantis.build.variant";
